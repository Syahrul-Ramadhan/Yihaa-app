<div class="rounded-2xl px-6 py-4 flex items-center gap-3" style="background-color:#0E2F3E; box-shadow:0 4px 10px rgba(0, 224, 255, 0.15);">
    ...
    <input type="text" placeholder="Search" class="w-full bg-transparent focus:outline-none" style="color:#FFFFFF;" />
</div>
