...
@section('content')
    <div class="flex items-center md:h-auto min-h-screen overflow-hidden">
        <div class="bg-white w-full min-h-screen md:min-h-0 rounded-t-2xl md:rounded-2xl md:mx-auto mt-20 px-6 py-10 md:w-1/3 md:mt-0">
            <div class="welcome-message text-gray-800 lg:text-center mb-3">
                <p class="font-semibold text-2xl sm:text">Sign In</p>
            </div>

            <!-- Form Login -->
            <div class="flex items-center justify-center ">
                <form action="#" method="POST" class="space-y-6 mt-3 w-full max-w-sm">
                    <x-_ui.input type="email" name="email" placeholder="Input your email" id="email" for="Email"/>
                    <x-_ui.passwordInput placeholder="Input your password" for="Password"/>
                    ...
                    <div class="flex justify-between">
                        <div class="checkbox">
                            ...
                            <label for="hs-default-checkbox" class="cursor-pointer text-sm text-gray-800 ms-3 dark:text-neutral-400">Ingatkan saya</label>
                        </div>
