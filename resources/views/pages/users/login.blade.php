...
<div class="flex items-center md:h-auto min-h-screen overflow-hidden">
    <div
        class="bg-white w-full min-h-screen md:min-h-0 rounded-t-2xl md:rounded-2xl md:mx-auto mt-20 px-6 py-10 md:w-1/3 md:mt-0">
        ...
        <div class="flex items-center justify-center">
            <form id="yihaa-login-form" class="space-y-6 mt-3 w-full max-w-sm" action="{{ route('login.process') }}"
                method="POST">
                @csrf
                ...
                <div class="flex justify-end items-center">
                    <a href="/forgot-password" class="text-base text-[#27D5E8] underline hover:text-[#198b97]">Forgot
                        password?</a>
                </div>

                <button type="submit" id="sign-in-btn"
                    class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#0D1517] text-white hover:bg-[#182427] cursor-pointer">
                    Sign In
                </button>
            </form>
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-base text-gray-800">Don't have an account? <a href="/register"
                    class="font-bold text-base text-[#27D5E8] underline hover:text-[#198b97]">Sign up</a></p>
        </div>
    </div>
</div>

@if(session('login_success'))
<div id="successModal" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
...
<div id="logoutModal" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div class="bg-white rounded-xl p-6 text-center w-72">
...
<div id="ErrorModal" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div class="bg-white rounded-xl p-6 text-center w-72">
