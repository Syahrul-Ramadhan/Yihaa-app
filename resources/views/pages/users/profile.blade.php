            ...
            <div class="flex items-start justify-between">
                <div class="flex items-center gap-6">
                    ...
                    <div class="relative">
                        ...
                        @else
                            <div class="w-32 h-32 rounded-full bg-gradient-to-br from-[#2aa3ef] to-[#1e7bb8] flex items-center justify-center border-4 border-[#2aa3ef]">
                                <span class="text-4xl font-bold">{{ strtoupper(substr($user['name'], 0, 1)) }}</span>
                            </div>
                        @endif
                        <div class="absolute bottom-0 right-0 w-8 h-8 bg-green-500 rounded-full border-4 border-[#1a1a1a]"></div>
                    </div>
                    ...
                    <div>
                        ...
                        @if($profile && $profile['university'])
                            <p class="text-gray-300 text-sm">
                                <i class="fas fa-university mr-2"></i>{{ $profile['university'] }}
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-gradient-to-br from-[#163F44] to-[#0a2020] rounded-2xl p-6 border border-gray-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Forum Card -->
                        <a href="{{ route('posts.index') }}" class="group bg-gradient-to-br from-[#1a3a3a] to-[#0a2020] rounded-xl p-6 border border-gray-700 hover:border-[#2aa3ef] transition-all duration-200 hover:scale-105">
                            <div class="flex items-center justify-between mb-4">
                                <div class="w-16 h-16 bg-[#2aa3ef]/20 rounded-lg flex items-center justify-center group-hover:bg-[#2aa3ef]/30 transition-all">
                                    <i class="fas fa-comments text-3xl text-[#2aa3ef]"></i>
                                </div>
                        ...
                        <!-- Event Hub Card -->
                        <a href="{{ route('seminar') }}" class="group bg-gradient-to-br from-[#2a1a3a] to-[#150a2a] rounded-xl p-6 border border-gray-700 hover:border-purple-500 transition-all duration-200 hover:scale-105">
                            <div class="flex items-center justify-between mb-4">
                                <div class="w-16 h-16 bg-purple-500/20 rounded-lg flex items-center justify-center group-hover:bg-purple-500/30 transition-all">
                        ...
                        <!-- Materials Card -->
                        <a href="{{ route('materi.index') }}" class="group bg-gradient-to-br from-[#1a3a2a] to-[#0a200a] rounded-xl p-6 border border-gray-700 hover:border-green-500 transition-all duration-200 hover:scale-105">
                            <div class="flex items-center justify-between mb-4">
                                <div class="w-16 h-16 bg-green-500/20 rounded-lg flex items-center justify-center group-hover:bg-green-500/30 transition-all">
                        ...
                        <a href="{{ route('teams.index') }}" class="group bg-gradient-to-br from-[#3a2a1a] to-[#2a1a0a] rounded-xl p-6 border border-gray-700 hover:border-orange-500 transition-all duration-200 hover:scale-105">
                            <div class="flex items-center justify-between mb-4">
                                <div class="w-16 h-16 bg-orange-500/20 rounded-lg flex items-center justify-center group-hover:bg-orange-500/30 transition-all">
                ...
                <div class="bg-gradient-to-br from-[#163F44] to-[#0a2020] rounded-2xl p-6 border border-gray-700">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-white">Kontribusi Terbaru</h2>
                        <button class="text-[#2aa3ef] hover:text-[#1e7bb8] text-sm font-medium">
                            <i class="fas fa-plus mr-1"></i>Tambah Kontribusi
                        </button>
                    </div>
                    ...
                    @if(count($contributions) > 0)
                        <div class="space-y-4">
                            @foreach($contributions as $contribution)
                                <div class="bg-gradient-to-br from-[#1a3a3a] to-[#0a2020] rounded-xl p-5 border border-gray-700">
                                    <div class="flex items-start justify-between mb-2">
                                        <h3 class="font-semibold text-lg text-white">{{ $contribution['title'] }}</h3>
                                        <span class="text-gray-400 text-sm">{{ \Carbon\Carbon::parse($contribution['contribution_date'])->format('M d, Y') }}</span>
                                    </div>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-400">Belum ada kontribusi</p>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="space-y-8">
                ...
                @if($profile && $profile['role_in_team'])
                    <div class="bg-gradient-to-br from-[#163F44] to-[#0a2020] rounded-2xl p-6 border border-gray-700">
                        ...
                        <div class="bg-gradient-to-r from-[#2aa3ef]/20 to-purple-500/20 rounded-xl p-4 border border-[#2aa3ef]/30">
                ...
                <div class="bg-gradient-to-br from-[#163F44] to-[#0a2020] rounded-2xl p-6 border border-gray-700">
                    ...
                    @if(count($teams) > 0)
                        <div class="space-y-3">
                            @foreach($teams as $team)
                                <a href="{{ route('teams.show', $team['team_id']) }}" 
                                    ...
                                    @else
                                        <div class="w-12 h-12 bg-gradient-to-br from-[#2aa3ef] to-purple-500 rounded-lg flex items-center justify-center">
                        ...
                        @if(count($teams) >= 3)
                            <a href="{{ route('teams.index') }}" class="block text-center mt-4 text-[#2aa3ef] hover:text-[#1e7bb8] text-sm font-medium">
