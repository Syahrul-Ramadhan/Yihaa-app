...
@section('content')
    <div class="flex items-center md:h-auto min-h-screen overflow-hidden">
      ...
      <!-- Form Register -->
        ...
        <form id="yihaa-register-form" class="space-y-6 mt-3 w-full max-w-sm">
          @csrf
          ...
          <button type="button" id="register-btn" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#0D1517] text-white hover:bg-[#182427] focus:outline-hidden cursor-pointer disabled:opacity-50">
          Register
                    </button>
                </form>
            </div>
